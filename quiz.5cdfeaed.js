...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.addCardMarkupExp=void 0;var e=require("./quiz-ref");function r({pages:e,currentPage:r,links:a}){return`<p class="card-wrap__desc">${e[r-1].p}</p>\n              <img class="card-wrap__img" src="${a[e[r-1].background]}" alt="" />`}function a({pages:a,pageDone:s,svg:n,gender:d}){const t=r({pages:a,currentPage:s,links:n});e.ref.heading.style.display="none",e.ref.answerList.style.display="none",e.ref.cardWrap.style.display="",e.ref.containerHero.classList.add("hero__container--card"),e.ref.containerHero.style.backgroundImage="",e.ref.backgroundMask.classList.add("hero__mask-svg--card"),"male"===d?e.ref.cardButtonWrap.classList.add("card__button-wrap--male"):e.ref.cardButtonWrap.classList.add("card__button-wrap--female"),e.ref.cardWrapContent.innerHTML="",e.ref.cardWrapContent.insertAdjacentHTML("beforeend",t)}const s=({pages:e,pageDone:r,svg:s,gender:n})=>a({pages:e,pageDone:r,svg:s,gender:n});exports.addCardMarkupExp=s;
},{"./quiz-ref":"CXGo"}],"rDXu":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.addChoiceMarkupExp=void 0;var e=require("./quiz-ref");function r(){e.ref.heading.style.display="",e.ref.choiceWrap.style.display="",e.ref.cardWrap.style.display="none",e.ref.containerHero.classList.remove("hero__container--card"),e.ref.backgroundMask.classList.remove("hero__mask-svg--card")}const a=()=>r();exports.addChoiceMarkupExp=a;
...
module.exports="/keto-diet-test/symbol-defs.36f47932.svg";
...
"use strict";var e=c(require("lodash.throttle")),a=c(require("./js/progress-percent")),r=require("./js/progress-dot"),t=require("./js/progress-line"),d=require("./js/pages"),s=require("./js/add-markup-answers"),n=require("./js/add-markup-progress"),p=require("./js/add-markup-card"),o=require("./js/add-markup-choice"),u=c(require("./images/quiz-bg/*.jpeg")),g=c(require("./images/*.svg"));function c(e){return e&&e.__esModule?e:{default:e}}let i=Number(localStorage.getItem("page")),l=localStorage.getItem("gender");const E=d.pages.length;"quiz"===d.pages[i-1].type&&((0,s.addBackgroundExp)(d.pages,i,u.default),(0,s.addHeaderIconExp)(d.pages,i,g.default),(0,s.addQuestionExp)(d.pages,i),(0,s.addAnswersMarkupExp)({pages:d.pages,pageDone:i,svg:g.default,gender:l})),"card"===d.pages[i-1].type&&(0,p.addCardMarkupExp)({pages:d.pages,pageDone:i,svg:g.default,gender:l}),"choice"===d.pages[i-1].type&&((0,s.addBackgroundExp)(d.pages,i,u.default),(0,s.addHeaderIconExp)(d.pages,i,g.default),(0,s.addQuestionExp)(d.pages,i),(0,o.addChoiceMarkupExp)({pages:d.pages,pageDone:i,svg:g.default,gender:l})),(0,n.addProgressDotMarkupExp)(d.pages);const f={progressStart:document.querySelector(".progress__section"),answers:document.querySelector(".quiz-list"),backButton:document.querySelector(".progress__button-link--back"),cardNextButton:document.querySelector(".card__button-link")},x=(0,e.default)(m,700);function m(){if(f.progressStart.getBoundingClientRect().top<=document.documentElement.clientHeight)return(0,a.default)(i,E),(0,r.onDoneDotExp)(i),(0,t.onDoneLineExp)(i,E),window.removeEventListener("scroll",x)}function k(e,a){localStorage.setItem("page",`${e}`),i=localStorage.getItem("page"),(0,r.removeDoneDotExp)(),(0,t.clearDoneLineExp)(),"quiz"===d.pages[i-1].type&&((0,s.addBackgroundExp)(d.pages,i,u.default),(0,s.addHeaderIconExp)(d.pages,i,g.default),(0,s.addQuestionExp)(d.pages,i),(0,s.addAnswersMarkupExp)({pages:d.pages,pageDone:i,svg:g.default,gender:l})),"card"===d.pages[i-1].type&&(0,p.addCardMarkupExp)({pages:d.pages,pageDone:i,svg:g.default,gender:l}),"choice"===d.pages[i-1].type&&((0,s.addBackgroundExp)(d.pages,i,u.default),(0,s.addHeaderIconExp)(d.pages,i,g.default),(0,s.addQuestionExp)(d.pages,i),(0,o.addChoiceMarkupExp)({pages:d.pages,pageDone:i,svg:g.default,gender:l})),(0,r.removeOldActiveDotExp)(a),window.addEventListener("scroll",x)}function v(){const e=i;k(Number(i)+1,e)}function q(e){e.preventDefault();const a=i;k(Number(i)+1,a)}function D(e){if(1===Number(i))return;e.preventDefault();const a=i;k(Number(i)-1,a)}window.addEventListener("scroll",x),f.answers.addEventListener("click",q),f.backButton.addEventListener("click",D),f.cardNextButton.addEventListener("click",v);
},{"lodash.throttle":"FNyO","./js/progress-percent":"xtzB","./js/progress-dot":"tuDp","./js/progress-line":"wFNr","./js/pages":"KUk1","./js/add-markup-answers":"a6HF","./js/add-markup-progress":"v3Z2","./js/add-markup-card":"Z2Gu","./js/add-markup-choice":"rDXu","./images/quiz-bg/*.jpeg":"S67B","./images/*.svg":"uUbn"}]},{},["rAAd"], null)
//# sourceMappingURL=/keto-diet-test/quiz.5cdfeaed.js.map